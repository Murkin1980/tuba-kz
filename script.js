...
• Комментарии: ${comments}`;
    ...
    submitBtn.textContent = "Открыть заявку в WhatsApp";
    
    formSuccess.style.display = "block";
    formSuccess.textContent = "WhatsApp открыт. Проверьте подготовленное сообщение и нажмите «Отправить».";
...
const faqDatabase = [
  {
    ...
    answer: "Выезд на замер и его условия согласовываются перед встречей. Свяжитесь с TUBA, чтобы уточнить доступное время и зону выезда."
  },
  {
    keys: ["срок", "время", "сколько", "изготовление", "производство"],
    answer: "Срок зависит от типа мебели, материалов и сложности проекта. Точный срок рассчитывается после согласования проекта и фиксируется в договоре."
  },
  {
    keys: ["цена", "стоимость", "калькулятор", "расчет", "бюджет"],
    answer: "Цена зависит от размеров, материалов, комплектации и сложности проекта. Заполните форму выше или пройдите опрос в чате, чтобы подготовить запрос на ориентировочный расчет."
  },
  {
    keys: ["гарантия", "качество", "договор", "рассрочка", "каспи"],
    answer: "Комплектация, стоимость, сроки, порядок оплаты и гарантийные условия согласовываются с заказчиком и фиксируются в договоре до начала работ."
  }
];
